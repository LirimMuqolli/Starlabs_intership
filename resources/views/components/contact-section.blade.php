...
<section class="font-sans antialiased text-black-900 leading-normal tracking-wider  bg-cover" style="background-image:url('https://img.freepik.com/free-photo/top-view-chat-bubbles-with-telephone-receiver-copy-space_23-2148796078.jpg?w=1060&t=st=1664622960~exp=1664623560~hmac=90f8b4cd9ef2241aeded324fee71b4f652315d3b925cc4851372f89a83b93855');">
...
<div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0" >
  ...
  <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0"  >
      ...
      <div class="p-4 md:p-12 text-center lg:text-left">
          ...
          <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 "></div>
          
          <h1 class="text-3xl font-bold pt-8 lg:pt-0 text-cyan-500">Contact Us</h1>
  ...
  <!-- Pin to top right corner -->
    <div class="absolute top-40 right-10 h-12 w-18 p-4">
