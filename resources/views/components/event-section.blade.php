                        ...
                        <div class="ml-4 mt-2 flex-shrink-0">
                            @if (isset($href))
                                <a href="{{ $href }}"
                                    ...
                                    <button type="button"
                                        class="relative inline-flex items-center  py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500">View
                                        All </button>
