...
<x-app-layout>
    ...
    <div id="default-carousel"
        class="relative w-full h-full bg-[url('https://images.pexels.com/photos/919734/pexels-photo-919734.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-cover bg-center  "
        style="backdrop-filter: blur(20px);" data-carousel="static">
        <div class="absolute inset-0  bg-blue-500 mix-blend-hue"></div>
        ...
        <div id="default-carousel" class="container mx-auto relative" data-carousel="static">
            <div class="relative pt-64 pb-10 shadow-2xl overflow-hidden">
                <img class="absolute inset-0 shadow-2xl rounded-lg object-cover  h-full w-full"
    ...
    <div class="flex flex-wrap sticky top-0 z-40 bg-gray-100 border-b border-gray-200">
    ...
    <div class="container mx-auto flex flex-wrap ">
        ...
        <!-- Post Section -->
        <section class="w-full md:w-2/3 flex flex-col items-left  ">


            <article class="flex flex-col  overflow-hidden rounded-lg sm:rounded-lg bg-gray-100 border border-gray-200 my-4  ">
                <!-- Article Image -->
                    ...
                    <div class="col-start-1 pl-4 col-span-4 " id="description">
                        <div class="flex">
                            {{-- @forelse ($categorys as $category)
                                <a href="#"
                                    class="bg-blue-100 mb-4 hover:bg-blue-200 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 dark:hover:bg-blue-300">{{ $category->title }}</a>
            ...
            <div id="date"
                class="w-full flex flex-col text-center md:text-left md:flex-row  overflow-hidden rounded-lg sm:rounded-lg bg-gray-100 border border-gray-200 mt-4">
                        ...
                        <div date-rangepicker class="flex items-center">
                            <div class="relative">
                                ...
                                <input name="start" type="text"
                                    ...
                                    value="{{ \Carbon\Carbon::parse($event->start_data)->isoFormat('MMM Do YYYY h:mm') }}"
                                    disabled placeholder="Select date start">
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <input name="end" type="text"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    value="{{ \Carbon\Carbon::parse($event->end_data)->isoFormat('MMM Do YYYY h:mm') }}"
                                    disabled placeholder="Select date end">
                            </div>
                        </div>
                ...
                <div class=" p-4 flex items-center space-x-4">
                    ...
                    <div class="font-medium dark:text-white">
                        ...
                        <iframe
                            ...
                            width="100%" height="270" frameborder="0" scrolling="no" marginheight="0"
                            marginwidth="0">
                        </iframe>
                    </div>
                </div>
            ...
            <div id="host"
                class="w-full flex flex-col text-center md:text-left md:flex-row  overflow-hidden rounded-lg sm:rounded-lg bg-gray-100 border border-gray-200 mt-4">
                <div class=" p-4 flex items-center space-x-4">
                    <img class="w-20 h-20 rounded" src="https://source.unsplash.com/collection/1346951/150x150?sig=1"
                        alt="">
                    <div class="font-medium dark:text-white">
        ...
        <aside id="parentPurchase" x-data="{ open: false }" x-cloak
            class="w-full md:w-1/3 flex flex-col items-center px-3  ">
            <div id="purchaseDiv"
                class="w-full overflow-hidden sm:rounded-lg bg-white flex flex-col my-4 p-6 sticky top-16 z-50">
...
<div class="mt-4 lg:row-span-3 lg:mt-0">
                ...
                <form class="mt-10">
                    <button type="submit"
                        class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-blue-600 py-3 px-8 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Buy Ticket</button>
                </form>
            </div>
