...
<nav x-data="{ open: false, transprent: false }" class="navbar py-4 backdrop-blur-xl bg-white sticky top-0 left-0 right-0 z-10 border-bottom shadow-sm">
                ...
                <div class="flex items-center">
                    <a href="{{ route('homepage') }}" class="cursor-pointer">
                        <h3 class="text-2xl font-medium text-cyan-500">
                            <img class="h-12 w-150 object-cover" src="{{ url('/images/starLords.png') }}"
                                alt="Store Logo">
                        </h3>
                    </a>
                </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                @auth
                    <x-jet-responsive-nav-link
                        href="{{ route('profile.user.single', ['username' => Auth::user()->username()]) }}"
                        :active="request()->routeIs('profile.user.single', ['username' => Auth::user()->username()])">
                        {{ __('Setting') }}
                    </x-jet-responsive-nav-link>
                @endauth
